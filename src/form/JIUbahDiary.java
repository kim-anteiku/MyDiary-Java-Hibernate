...
//-----------------------------------------------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        UbahDiaryButton = new javax.swing.JButton();
        ...
        UbahDiaryButton.setBackground(new java.awt.Color(0, 204, 0));
        UbahDiaryButton.setForeground(new java.awt.Color(255, 255, 255));
        UbahDiaryButton.setText("Ubah");
        UbahDiaryButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UbahDiaryButtonActionPerformed(evt);
            }
        });
        UbahDiaryButton.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                UbahDiaryButtonKeyPressed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(148, 148, 148)
                        .addComponent(UbahDiaryButton, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(29, 29, 29)
    ...
    //event handling
    private void UbahDiaryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UbahDiaryButtonActionPerformed
        ...
        //eksekusi variable
        try{
            control.ControlDiary.ubahDiary(id, judul, isi, tgl);
        }finally{
    ...
    }//GEN-LAST:event_UbahDiaryButtonActionPerformed
    //-----------------------------------------------------------------------------------------------------
    ...
    private void UbahDiaryButtonKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_UbahDiaryButtonKeyPressed
    ...
    }//GEN-LAST:event_UbahDiaryButtonKeyPressed
    ...
    private javax.swing.JButton UbahDiaryButton;
